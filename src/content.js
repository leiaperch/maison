...
export const rooms = [
  {
    ...
    items: [
      ...
      { id: 'sofa', at: 0.05, model: '/models/sofa_02/sofa_02_1k.gltf', name: 'Banquette Loire', price: 3900, pos: [-2.7, 0, -6.9], rot: 0.35,
        ...
        tint: [{ material: 'sofa_02', label: 'Tissu', options: [{ name: 'Vert forêt', hex: '#3d5a48' }, { name: 'Ardoise', hex: '#4b525a' }, { name: 'Ocre', hex: '#b7893f', price: 200 }, { name: 'Lin naturel', hex: '#c9bda6', price: 200 }] , patterns: true }],
        variants: [{ name: 'Canapé Frangé', model: '/models/sofa_03/sofa_03_1k.gltf', price: 4200, tint: [{ material: 'sofa_03', label: 'Tissu', options: LIN(120), patterns: true }] }, { name: 'Canapé Club', model: '/models/Sofa_01/Sofa_01_1k.gltf', price: 3400, tint: [{ material: 'Sofa_01', label: 'Cuir', options: CUIR(140) }] }] },
      ...
      { id: 'chair', at: 0.12, model: '/models/modern_arm_chair_01/modern_arm_chair_01_2k.gltf', name: 'Fauteuil Ormeau', price: 2450, pos: [0.77, 0, -6.12], rot: -0.35,
        ...
        variants: [{ name: 'Fauteuil Repos', model: '/models/mid_century_lounge_chair/mid_century_lounge_chair_1k.gltf', price: 1750, tint: [{ material: 'mid_century_lounge_chair', label: 'Cuir', options: CUIR(120) }] }, { name: 'Fauteuil Bergère', model: '/models/ArmChair_01/ArmChair_01_1k.gltf', price: 1900, tint: [{ material: 'Armchair_01', label: 'Tissu', options: LIN(90), patterns: true }] }, { name: 'Fauteuil Vert', model: '/models/GreenChair_01/GreenChair_01_1k.gltf', price: 1450, tint: [{ material: 'GreenChair_01', label: 'Tissu', options: LIN(60), patterns: true }] }, { name: 'Rocking-chair', model: '/models/Rockingchair_01/Rockingchair_01_1k.gltf', price: 980, tint: [{ material: 'Rockingchair_01', label: 'Bois', options: BOIS(0) }] }] },
      ...
      { id: 'side', at: 0.24, model: '/models/side_table_01/side_table_01_1k.gltf', name: 'Guéridon Aube', price: 420, pos: [-1.02, 0, -6.29], rot: 0.3,
        ...
        variants: [{ name: 'Guéridon Bas', model: '/models/small_wooden_table_01/small_wooden_table_01_1k.gltf', price: 390, tint: [{ material: 'small_wooden_table_01', label: 'Bois', options: BOIS(0) }] }, { name: 'Chevet Classique', model: '/models/ClassicNightstand_01/ClassicNightstand_01_1k.gltf', price: 520, tint: [{ material: 'ClassicNightstand_01', label: 'Bois', options: BOIS(0) }] }] },
      // ceramic_vase_02 — 0,22 × 0,31, posé sur le guéridon
      { id: 'vase', at: 0.28, model: '/models/ceramic_vase_02/ceramic_vase_02_1k.gltf', name: 'Vase Grès', price: 140, on: 'side', pos: [-1.02, 0.55, -6.29], rot: 0,
        ...
        variants: [{ name: 'Vase Col', model: '/models/ceramic_vase_04/ceramic_vase_04_1k.gltf', price: 120, tint: [{ material: 'ceramic_vase_04', label: 'Émail', options: GRES() }] }, { name: 'Vase Boule', model: '/models/ceramic_vase_01/ceramic_vase_01_1k.gltf', price: 130, tint: [{ material: 'ceramic_vase_01', label: 'Émail', options: GRES() }] }, { name: 'Vase Antique', model: '/models/antique_ceramic_vase_01/antique_ceramic_vase_01_1k.gltf', price: 260, tint: [] }, { name: 'Vase Laiton', model: '/models/brass_vase_01/brass_vase_01_1k.gltf', price: 210, tint: [{ material: 'brass_vase_001', label: 'Métal', options: METAL(0) }] }] },
      // Camera_01 — 0,21 × 0,08, sur le guéridon aussi
      { id: 'camera', at: 0.32, model: '/models/Camera_01/Camera_01_1k.gltf', name: 'Appareil Argentique', price: 0, on: 'side', pos: [-0.8, 0.55, -6.06], rot: 0.9,
      ...
      { id: 'coffee', at: 0.39, model: '/models/modern_coffee_table_01/modern_coffee_table_01_1k.gltf', name: 'Table basse Lisse', price: 1180, pos: [2.2, 0, -6.3], rot: 0.15,
        ...
        variants: [{ name: 'Table basse Carrée', model: '/models/modern_coffee_table_02/modern_coffee_table_02_1k.gltf', price: 1350, tint: [{ material: 'modern_coffee_table_02_wood', label: 'Bois', options: BOIS(0) }, { material: 'modern_coffee_table_02_base', label: 'Piètement', options: METAL(0) }] }, { name: 'Table basse Ronde', model: '/models/coffee_table_round_01/coffee_table_round_01_1k.gltf', price: 1290, tint: [{ material: 'coffee_table_round_01', label: 'Bois', options: BOIS(0) }] }, { name: 'Table basse Atelier', model: '/models/CoffeeTable_01/CoffeeTable_01_1k.gltf', price: 1490, tint: [{ material: 'CoffeeTable_01', label: 'Bois', options: BOIS(0) }] }] },
      // book_encyclopedia_set_01 — 0,04 × 0,24 × 0,17, sur la table basse
      { id: 'books', at: 0.45, model: '/models/book_encyclopedia_set_01/book_encyclopedia_set_01_1k.gltf', name: 'Encyclopédie', price: 0, on: 'coffee', pos: [2.1, 0.39, -6.15], rot: 0.3,
      ...
      { id: 'brass', at: 0.64, model: '/models/brass_vase_01/brass_vase_01_1k.gltf', name: 'Vase Laiton', price: 210, on: 'coffee', pos: [2.45, 0.39, -6.5], rot: 0,
        caption: ['Et au centre', 'un éclat'], text: 'Laiton martelé, patine libre.', tint: [{ material: 'brass_vase_001', label: 'Métal', options: METAL(60) }],
        variants: [{ name: 'Vase Laiton haut', model: '/models/brass_vase_02/brass_vase_02_1k.gltf', price: 240, tint: [{ material: 'brass_vase_02', label: 'Métal', options: METAL(0) }] }, { name: 'Petit Laiton', model: '/models/brass_vase_03/brass_vase_03_1k.gltf', price: 90, tint: [{ material: 'brass_vase_03', label: 'Métal', options: METAL(0) }] }, { name: 'Soliflore', model: '/models/ceramic_vase_03/ceramic_vase_03_1k.gltf', price: 70, tint: [{ material: 'ceramic_vase_03', label: 'Émail', options: GRES() }] }] },
      ...
      { id: 'plant', at: 0.72, model: '/models/potted_plant_02/potted_plant_02_1k.gltf', name: 'Monstera', price: 0, pos: [3.1, 0, -6.9], rot: 0.4,
        ...
        variants: [{ name: 'Laurier en pot', model: '/models/potted_plant_01/potted_plant_01_1k.gltf', price: 0, tint: [] }, { name: 'Anthurium', model: '/models/anthurium_botany_01/anthurium_botany_01_1k.gltf', price: 0, tint: [] }, { name: 'Succulente', model: '/models/potted_plant_04/potted_plant_04_1k.gltf', price: 0, tint: [] }] },
    ],
  },
  {
    ...
    items: [
      ...
      { id: 'kchair1', at: 0.12, model: '/models/painted_wooden_chair_01/painted_wooden_chair_01_1k.gltf', name: 'Chaise Sillon', price: 340, pos: [-1.35, 0, -3.9], rot: 0.6,
        caption: ['Des chaises', 'qui ne grincent pas'], text: 'Hêtre massif, dossier cintré à la vapeur, peinture à l’huile.', tint: [{ material: 'painted_wooden_chair_01', label: 'Peinture', options: PEINTURE() , patterns: true }],
        variants: [{ name: 'Chaise Sillon haute', model: '/models/painted_wooden_chair_02/painted_wooden_chair_02_1k.gltf', price: 380, tint: [{ material: 'painted_wooden_chair_02', label: 'Peinture', options: PEINTURE(), patterns: true }] }, { name: 'Chaise Bistrot', model: '/models/dining_chair_02/dining_chair_02_1k.gltf', price: 290, tint: [{ material: 'dining_chair_02', label: 'Bois', options: BOIS(0) }] }, { name: 'Chaise d’école', model: '/models/SchoolChair_01/SchoolChair_01_1k.gltf', price: 210, tint: [{ material: 'SchoolChair_01', label: 'Bois', options: BOIS(0) }] }] },
      { id: 'kchair2', at: 0.17, model: '/models/painted_wooden_chair_01/painted_wooden_chair_01_1k.gltf', name: 'Chaise Sillon', price: 340, pos: [0.35, 0, -3.8], rot: -0.5,
        caption: ['Et une', 'deuxième'], text: 'Vendue à l’unité, jamais par lot.', tint: [{ material: 'painted_wooden_chair_01', label: 'Peinture', options: PEINTURE() , patterns: true }],
        variants: [{ name: 'Chaise Sillon haute', model: '/models/painted_wooden_chair_02/painted_wooden_chair_02_1k.gltf', price: 380, tint: [{ material: 'painted_wooden_chair_02', label: 'Peinture', options: PEINTURE(), patterns: true }] }, { name: 'Chaise Bistrot', model: '/models/dining_chair_02/dining_chair_02_1k.gltf', price: 290, tint: [{ material: 'dining_chair_02', label: 'Bois', options: BOIS(0) }] }, { name: 'Chaise d’école', model: '/models/SchoolChair_01/SchoolChair_01_1k.gltf', price: 210, tint: [{ material: 'SchoolChair_01', label: 'Bois', options: BOIS(0) }] }] },
      ...
      { id: 'stool2', at: 0.63, model: '/models/bar_chair_round_01/bar_chair_round_01_1k.gltf', name: 'Tabouret Haut', price: 290, pos: [4.1, 0, -3.05], rot: 0.4,
        ...
        variants: [{ name: 'Tabouret Bas', model: '/models/wooden_stool_01/wooden_stool_01_1k.gltf', price: 120, tint: [{ material: 'wooden_stool_01', label: 'Bois', options: BOIS(0) }] }, { name: 'Tabouret Métal haut', model: '/models/metal_stool_01/metal_stool_01_1k.gltf', price: 190, tint: [{ material: 'metal_stool_01', label: 'Métal', options: METAL(0) }] }, { name: 'Tabouret Peint', model: '/models/painted_wooden_stool/painted_wooden_stool_1k.gltf', price: 160, tint: [{ material: 'painted_wooden_stool', label: 'Peinture', options: PEINTURE(), patterns: true }] }] },
      // wicker_basket_01 — 0,38 × 0,12 × 0,30 : une corbeille plate, pas un panier de marché
      { id: 'basket', at: 0.72, model: '/models/wicker_basket_01/wicker_basket_01_1k.gltf', name: 'Corbeille Osier', price: 70, pos: [3.4, 0, -3.4], rot: 0.2,
        caption: ['Et une corbeille', 'pour le pain'], text: 'Osier tressé main, 38 cm.', tint: [],
        variants: [{ name: 'Seau Bois', model: '/models/wooden_bucket_01/wooden_bucket_01_1k.gltf', price: 60, tint: [{ material: 'wooden_bucket_01', label: 'Bois', options: BOIS(0) }] }, { name: 'Cagette', model: '/models/wooden_crate_01/wooden_crate_01_1k.gltf', price: 40, tint: [{ material: 'wooden_crate_01', label: 'Bois', options: BOIS(0) }] }, { name: 'Panier Rond', model: '/models/wicker_basket_02/wicker_basket_02_1k.gltf', price: 45, tint: [] }] },
    ],
  },
  {
    ...
    items: [
      ...
      { id: 'pillows', at: 0.13, model: '/models/throw_pillows_01/throw_pillows_01_1k.gltf', name: 'Coussins Lin', price: 95, pos: [-0.35, 0.36, -3.65], rot: 0.6,
        caption: ['Des coussins', 'en lin lavé'], text: 'Housse déhoussable, garnissage plumes.', tint: [{ material: 'throw_pillows_01', label: 'Tissu', options: LIN(0) , patterns: true }] },
      ...
      { id: 'night1', at: 0.22, model: '/models/painted_wooden_nightstand/painted_wooden_nightstand_1k.gltf', name: 'Chevet Aube', price: 480, pos: [-1.5, 0, -3.6], rot: 0.2,
        caption: ['Un chevet', 'de chaque côté'], text: 'Un tiroir, une niche, peinture à l’huile.', tint: [{ material: 'painted_wooden_nightstand', label: 'Peinture', options: PEINTURE() , patterns: true }],
        variants: [{ name: 'Chevet Classique', model: '/models/ClassicNightstand_01/ClassicNightstand_01_1k.gltf', price: 520, tint: [{ material: 'ClassicNightstand_01', label: 'Bois', options: BOIS(0) }] }, { name: 'Chevet Bas', model: '/models/small_wooden_table_01/small_wooden_table_01_1k.gltf', price: 390, tint: [{ material: 'small_wooden_table_01', label: 'Bois', options: BOIS(0) }] }] },
      // Lantern_01 — 0,12 × 0,29, sur le chevet (0,66)
      { id: 'lantern', at: 0.28, model: '/models/Lantern_01/Lantern_01_1k.gltf', name: 'Lanterne', price: 160, on: 'night1', pos: [-1.57, 0.66, -3.65], rot: 0.4, glow: { y: 0.18, color: '#ffb866', intensity: 2.5, distance: 3 },
      ...
      { id: 'clock', at: 0.35, model: '/models/alarm_clock_01/alarm_clock_01_1k.gltf', name: 'Réveil', price: 60, on: 'night1', pos: [-1.35, 0.66, -3.47], rot: 0.9,
        caption: ['Et l’heure', 'qu’il est'], text: 'Mécanique, il sonne fort.', tint: [] },
      // mid_century_lounge_chair — 1,01 × 1,17 × 1,19
      { id: 'lounge', at: 0.46, model: '/models/mid_century_lounge_chair/mid_century_lounge_chair_1k.gltf', name: 'Fauteuil Repos', price: 1750, pos: [2.1, 0, -4.1], rot: -0.6,
        ...
        variants: [{ name: 'Fauteuil Bergère', model: '/models/ArmChair_01/ArmChair_01_1k.gltf', price: 1900, tint: [{ material: 'Armchair_01', label: 'Tissu', options: LIN(90), patterns: true }] }, { name: 'Fauteuil Vert', model: '/models/GreenChair_01/GreenChair_01_1k.gltf', price: 1450, tint: [{ material: 'GreenChair_01', label: 'Tissu', options: LIN(60), patterns: true }] }, { name: 'Rocking-chair', model: '/models/Rockingchair_01/Rockingchair_01_1k.gltf', price: 980, tint: [{ material: 'Rockingchair_01', label: 'Bois', options: BOIS(0) }] }] },
      // side_table_tall_01 — 0,38 × 0,76 × 0,38 : la sellette à côté du fauteuil
      { id: 'pedestal', at: 0.55, model: '/models/side_table_tall_01/side_table_tall_01_1k.gltf', name: 'Sellette Brin', price: 380, pos: [2.6, 0, -4.2], rot: 0.3,
        ...
        variants: [{ name: 'Chevet Classique', model: '/models/ClassicNightstand_01/ClassicNightstand_01_1k.gltf', price: 520, tint: [{ material: 'ClassicNightstand_01', label: 'Bois', options: BOIS(0) }] }, { name: 'Sellette Peinte', model: '/models/painted_wooden_stool/painted_wooden_stool_1k.gltf', price: 160, tint: [{ material: 'painted_wooden_stool', label: 'Peinture', options: PEINTURE(), patterns: true }] }] },
      // ceramic_vase_04 — 0,18 × 0,34, sur la sellette
      { id: 'vase3', at: 0.62, model: '/models/ceramic_vase_04/ceramic_vase_04_1k.gltf', name: 'Vase Col', price: 120, on: 'pedestal', pos: [2.6, 0.76, -4.2], rot: 0,
        caption: ['Et un vase', 'au col étroit'], text: 'Grès blanc, une tige suffit.', tint: [],
        variants: [{ name: 'Vase Col', model: '/models/ceramic_vase_04/ceramic_vase_04_1k.gltf', price: 120, tint: [{ material: 'ceramic_vase_04', label: 'Émail', options: GRES() }] }, { name: 'Vase Boule', model: '/models/ceramic_vase_01/ceramic_vase_01_1k.gltf', price: 130, tint: [{ material: 'ceramic_vase_01', label: 'Émail', options: GRES() }] }, { name: 'Vase Antique', model: '/models/antique_ceramic_vase_01/antique_ceramic_vase_01_1k.gltf', price: 260, tint: [] }, { name: 'Vase Laiton', model: '/models/brass_vase_01/brass_vase_01_1k.gltf', price: 210, tint: [{ material: 'brass_vase_001', label: 'Métal', options: METAL(0) }] }] },
      // calathea_orbifolia_01 — 0,60 × 0,42 × 0,56
      { id: 'plant2', at: 0.72, model: '/models/calathea_orbifolia_01/calathea_orbifolia_01_1k.gltf', name: 'Calathea', price: 0, pos: [-1.85, 0, -4.35], rot: 0,
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'bench', at: 0.05, model: '/models/painted_wooden_bench/painted_wooden_bench_1k.gltf', name: 'Banc Vestiaire', price: 520, pos: [0.1, 0, -3.6], rot: 0.1,
        caption: ['Un banc', 'pour s’asseoir'], text: 'Pin peint à l’huile, il ne craint ni l’eau ni la vapeur.', tint: [{ material: 'painted_wooden_bench', label: 'Peinture', options: PEINTURE() , patterns: true }] },
      // wicker_basket_02 — 0,23 × 0,22 : une boîte, pas un panier à linge
      { id: 'basket2', at: 0.15, model: '/models/wicker_basket_02/wicker_basket_02_1k.gltf', name: 'Boîte d’osier', price: 45, on: 'bench', pos: [0.1, 0.6, -3.55], rot: 0.2,
      ...
      { id: 'stool3', at: 0.25, model: '/models/folding_wooden_stool/folding_wooden_stool_1k.gltf', name: 'Tabouret Pliant', price: 240, pos: [1.6, 0, -3.2], rot: 0.5,
        ...
        variants: [{ name: 'Tabouret Bas', model: '/models/wooden_stool_01/wooden_stool_01_1k.gltf', price: 120, tint: [{ material: 'wooden_stool_01', label: 'Bois', options: BOIS(0) }] }, { name: 'Tabouret Métal', model: '/models/metal_stool_02/metal_stool_02_1k.gltf', price: 150, tint: [{ material: 'metal_stool_02', label: 'Métal', options: METAL(0) }] }, { name: 'Tabouret Peint', model: '/models/painted_wooden_stool/painted_wooden_stool_1k.gltf', price: 160, tint: [{ material: 'painted_wooden_stool', label: 'Peinture', options: PEINTURE(), patterns: true }] }] },
      // wooden_bowl_02 — 0,13 × 0,07, sur le tabouret (0,44)
      { id: 'bowl2', at: 0.33, model: '/models/wooden_bowl_02/wooden_bowl_02_1k.gltf', name: 'Coupelle Frêne', price: 35, on: 'stool3', pos: [1.6, 0.44, -3.2], rot: 0,
      ...
      { id: 'candles', at: 0.42, model: '/models/brass_candleholders/brass_candleholders_1k.gltf', name: 'Bougeoirs', price: 140, pos: [2.4, 0, -3.6], rot: 0.3, glow: { y: 0.8, color: '#ffb266', intensity: 3, distance: 3.5,
        variants: [{ name: 'Bougeoir Bois', model: '/models/wooden_candlestick/wooden_candlestick_1k.gltf', price: 35, tint: [{ material: 'wooden_candlestick', label: 'Bois', options: BOIS(0) }] }] },
      ...
      { id: 'clay', at: 0.53, model: '/models/planter_pot_clay/planter_pot_clay_1k.gltf', name: 'Pot de terre', price: 40, pos: [3.0, 0, -3.35], rot: 0,
        ...
        variants: [{ name: 'Pot Céramique', model: '/models/ceramic_pot/ceramic_pot_1k.gltf', price: 60, tint: [] }, { name: 'Pot Émaillé', model: '/models/pot_enamel_01/pot_enamel_01_1k.gltf', price: 50, tint: [] }] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'garden', at: 0.05, model: '/models/outdoor_table_chair_set_01/outdoor_table_chair_set_01_1k.gltf', name: 'Table Terrasse', price: 1650, pos: [0.6, 0, -5.0], rot: 0.2,
        ...
        tint: [{ material: 'outdoor_table_chair_set_01_table', label: 'Bois', options: TECK(160) }, { material: 'outdoor_table_chair_set_01_chair', label: 'Assise', options: TECK(0) , patterns: true }] },
      ...
      { id: 'stool4', at: 0.41, model: '/models/folding_wooden_stool/folding_wooden_stool_1k.gltf', name: 'Tabouret Pliant', price: 240, pos: [1.3, 0, -3.9], rot: -0.4,
      ...
      { id: 'planter', at: 0.52, model: '/models/planter_box_02/planter_box_02_1k.gltf', name: 'Jardinière', price: 320, pos: [2.5, 0, -4.4], rot: 0.15,
        ...
        variants: [{ name: 'Jardinière Courte', model: '/models/planter_box_01/planter_box_01_1k.gltf', price: 240, tint: [{ material: 'planter_box_01', label: 'Bois', options: BOIS(0) }] }, { name: 'Jardinière Haute', model: '/models/planter_box_03/planter_box_03_1k.gltf', price: 380, tint: [{ material: 'planter_box_03', label: 'Bois', options: BOIS(0) }] }] },
      // potted_plant_01 — 0,59 × 1,34 × 0,63
      { id: 'tree', at: 0.62, model: '/models/potted_plant_01/potted_plant_01_1k.gltf', name: 'Laurier en pot', price: 0, pos: [3.3, 0, -4.7], rot: 0,
        caption: ['Et de l’ombre', 'à venir'], text: 'Offert avec toute commande. Feuillage persistant, il passe l’hiver dehors.', tint: [],
        variants: [{ name: 'Pachira', model: '/models/pachira_aquatica_01/pachira_aquatica_01_1k.gltf', price: 0, tint: [] }, { name: 'Monstera', model: '/models/potted_plant_02/potted_plant_02_1k.gltf', price: 0, tint: [] }] },
...
for (const r of rooms) {
  ...
  for (const it of r.items) { it.model = abs(it.model); (it.variants || []).forEach((v) => { v.model = abs(v.model); }); }
}
